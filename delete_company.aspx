<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete_company.aspx.cs" Inherits="ThermalCat.Default" %>
<!DOCTYPE html>
<html lang="pt-br">
	<head runat="server">
		<meta charset="utf-8">
    										...
    										<asp:Repeater runat="server" ID="listRepeater">
    											<ItemTemplate>
    												<tr>
    													...
    													<td><%#Eval("Estado") %></td>
    													<td><%#Eval("Cep") %></td>
    													<td><a class="fa fa-trash" onclick="return confirm('Deseja mesmo excluir <%#Eval("Nome") %>?')" style="font-size: 4vmin;" href="delete.aspx?id=<%#Eval("Id") %>&tabela=tbAfiliacao"></a></td>
    												</tr>
    											</ItemTemplate>
    										</asp:Repeater>
    									</tbody>
