<%@ Page Language="C#" AutoEventWireup="true" CodeFile="register_sensor.aspx.cs" Inherits="ThermalCat.Default" %>
<!DOCTYPE html>
<html lang="pt-br">
	<head runat="server">
		<meta charset="utf-8">
					...
					<div class="col-md-7 hidden-xs">
						<div id="RegForm" class="well" style="overflow-y: scroll;">
							<form runat="server" style="height: 73vmin;">
                            	...
                            	<asp:Button Id="Register" Text="Cadastrar" OnClick="Cadastrar" CssClass="btn btn-success" runat="server" />
