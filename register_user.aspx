<%@ Page Language="C#" AutoEventWireup="true" CodeFile="register_user.aspx.cs" Inherits="ThermalCat.Default" %>
<!DOCTYPE html>
<html lang="pt-br">
	<head runat="server">
		<meta charset="utf-8">
							...
							<form runat="server" style="height: 73vmin;">
								...
								<div class="form-group">
									<div class="form-inline">
										<div class="form-group">
											<asp:TextBox id="Login" CssClass="form-control" placeholder="Nome de Usuário" MaxLength="15" runat="Server" autofocus/>
										</div>
										<div class="form-group">
											<asp:TextBox id="FirstName" CssClass="form-control" placeholder="Nome" MaxLength="15" runat="Server"/>
										</div>
										<div class="form-group">
											<asp:TextBox id="LastName" CssClass="form-control" placeholder="Sobrenome" MaxLength="15" runat="Server"/>
										</div>
									</div>
								</div>
								<div class="form-group">
									<asp:TextBox id="Pass" Type="password" CssClass="form-control" placeholder="Senha" runat="Server"/>
								</div>
								<div class="form-group">
									<asp:TextBox id="ConfirmPass" Type="password" CssClass="form-control" placeholder="Confirmar Senha" runat="Server"/>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<asp:RadioButtonList ID="AccessLevel" runat="server"></asp:RadioButtonList>
								</div>
								<asp:Button Id="Register" Text="Cadastrar" CssClass="btn btn-success" OnClick="Cadastrar" runat="server" />
		...
		<script>
			$("i").click(function() {
			    if($(event.target).attr('id')=='UserForm'){
			        ...
			        window.location.replace("register_company.aspx");
			    } else if($(event.target).attr('id')=='SensorForm'){
			        window.location.replace("register_sensor.aspx");
			    }
			});
