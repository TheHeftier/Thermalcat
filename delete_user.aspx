<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete_user.aspx.cs" Inherits="ThermalCat.Default" %>
<!DOCTYPE html>
<html lang="pt-br">
	<head runat="server">
		<meta charset="utf-8">
    										...
    										<asp:Repeater runat="server" ID="listRepeater">
    											<ItemTemplate>
    												<tr>
    													...
    													<td><%#Eval("Nome") %></td>
    													<td><%#Eval("Sobrenome") %></td>
    													<td><%#Eval("Email") %></td>
    													<td><%#Eval("Empresa") %></td>
    													<td><a class="fa fa-trash" onclick="return confirm('Deseja mesmo excluir <%#Eval("Nome") %> <%#Eval("Sobrenome") %>?')" style="font-size: 4vmin;" href="delete.aspx?id=<%#Eval("Id") %>&tabela=tbUsuario"></a></td>
    												</tr>
    											</ItemTemplate>
    										</asp:Repeater>
    									</tbody>
