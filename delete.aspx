<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete.aspx.cs" Inherits="ThermalCat.Default" %>
<!DOCTYPE html>
<html lang="pt-br">
	<head runat="server">
		<meta charset="utf-8">
    ...
    <body>
        ...
        <section class="text-center" style="padding: 30vmin 40vmin;">
			<form id="form1" runat="server">
    			<div>
    				...
    				<div>
    					<asp:Button Text="Voltar" CssClass="btn btn-default" runat="server" ID="btnNao" OnClick="btnNao_Click" />
    				</div>
    			</div>
			</form>
		</section>
