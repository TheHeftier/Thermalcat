<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list_sensor.aspx.cs" Inherits="ThermalCat.Default" %>
<!DOCTYPE html>
<html lang="pt-br">
	<head runat="server">
		<meta charset="utf-8">
    										...
    										<asp:Repeater runat="server" ID="listRepeater">
    											<ItemTemplate>
    												<tr>
    													...
    													<td><%#Eval("Empresa") %></td>
    													<td><a class="fa fa-pencil" style="font-size: 4vmin;" href="edit_sensor.aspx?id=<%#Eval("Id") %>"></a></td>
    												</tr>
    											</ItemTemplate>
    										</asp:Repeater>
    									</tbody>
