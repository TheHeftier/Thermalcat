<%@ Page Language="C#" AutoEventWireup="true" CodeFile="support.aspx.cs" Inherits="ThermalCat.Default" %>
<!DOCTYPE html>
<html lang="pt-br">
	<head runat="server">
		<meta charset="utf-8">
        ...
        <link rel="icon" href="images/icons/logo/icon-72x72.png" />
    ...
    <body>
        <aside class="side-bar">
            ...
            <button id="SupportButton" onclick="location.href = 'support.aspx';" class="navbutton fa fa-desktop" data-toggle="tooltip" data-placement="right" title="Suporte"></button>
            <button id="ConfigButton" onclick="location.href = 'config.aspx';" class="navbutton fa fa-cog" data-toggle="tooltip" data-placement="right" title="Configurações"></button>
